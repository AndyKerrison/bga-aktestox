 ...
 * aktestox.js
 *
 * aktestox user interface script
 * 
...
function (dojo, declare) {
    return declare("bgagame.aktestox", ebg.core.gamegui, {
        constructor: function(){
            console.log('aktestox constructor');
        ...
        */
        ...
        setup: function( gamedatas )
        {
            ...
            for( var player_id in gamedatas.players )
            {
                ...
                console.log("setting up player " + player_id);
            }
            
            // TODO: Set up your game interface here, according to "gamedatas"
            console.log(gamedatas.board);
            for (var i=0; i< gamedatas.board.length; i++) {
                console.log(gamedatas.board[i]);
                if (gamedatas.board[i]["board_player"] != null) {
                    this.addTokenOnBoard(gamedatas.board[i]["board_x"], gamedatas.board[i]["board_y"], gamedatas.board[i]["board_player"]);
                }
            }
...
*/
        ...
        */
        ...
        updatePossibleMoves: function (possibleMoves) {
            ...
            //dojo.addClass('square_' + 1 + '_' + 1, 'possibleMove');
        ...
        */
        ...
        onPlayDisc: function (evt) {
            ...
            {
                this.ajaxcall("/aktestox/aktestox/playDisc.html", {
                    x: x,
                    y: y
        ...
        onMyMethodToCall1: function( evt )
        {
            ...
            this.ajaxcall( "/aktestox/aktestox/myAction.html", { 
                                                                    lock: true, 
                                                                    myArgument1: arg1, 
                                                                    myArgument2: arg2,
                                                                    ...
        ...
        */
        ...
        notif_playDisc: function (notif) {
            ...
            console.log("removing possible moves");
            dojo.query('.possibleMove').removeClass('possibleMove');
